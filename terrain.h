...
constexpr BLOCK BLOCK_WOOL_BLACK = 30;
constexpr BLOCK BLOCK_WOOL_RED = 31;
constexpr BLOCK BLOCK_WOOL_DARK_GREEN = 32;
constexpr BLOCK BLOCK_WOOL_BROWN = 33;
constexpr BLOCK BLOCK_WOOL_DARK_BLUE = 34;
constexpr BLOCK BLOCK_WOOL_PURPLE = 35;
constexpr BLOCK BLOCK_WOOL_CYAN = 36;
constexpr BLOCK BLOCK_WOOL_WHITE = 37;
constexpr BLOCK BLOCK_WOOL_GRAY = 38;
constexpr BLOCK BLOCK_WOOL_PINK = 39;
constexpr BLOCK BLOCK_WOOL_GREEN = 40;
constexpr BLOCK BLOCK_WOOL_YELLOW = 41;
